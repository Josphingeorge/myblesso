					...
					<div class="side-app">
						...
						<div class="row">
							<div class="col-lg-5 col-xl-4">
								<div class="card card-profile cover-image "  data-image-src="<?php echo base_url();?>/assets/images/photos/gradient3.jpg">
									<div class="card-body text-center">
										<img class="card-profile-img" src="<?php echo base_url();?>/assets/images/users/male/25.jpg" alt="img">
										<h3 class="mb-1 text-white">Robert McLean</h3>
										<p class="mb-2 text-white">Web Designer</p>
										<a class="btn btn-primary text-white btn-sm mt-2">
											<span class="fa fa-twitter"></span> Follow
										</a>
										<a href="<?php echo base_url('Editprofile');?>" class="btn btn-success btn-sm mt-2"><i class="fa fa-pencil" aria-hidden="true"></i> Edit profile</a>
									</div>
								</div>
								<div class="card p-5 ">
									...
									<div class="media-list">
										<div class="media mt-1 pb-2">
											...
											<div class="card-body ml-5 p-1">
												<h6 class="mediafont text-dark">Websites</h6><a class="d-block" href="">http://Jobslist.com</a> <a class="d-block" href="">http://Jobslist.net</a>
											</div>
											<!-- media-body -->
										</div>
										<!-- media -->
										...
										<div class="media mt-1">
											...
											<div class="card-body p-1 ml-5">
												<h6 class="mediafont text-dark">Twitter</h6><a class="d-block" href="#">@Jobslist</a>
											</div>
											<!-- media-body -->
										</div>
										<!-- media -->
											...
											<div class="fade show active " >
												<div class="table-responsive border ">
													<table class="table row table-borderless w-100 m-0 ">
														...
														<tbody class="col-lg-12 col-xl-6 p-0">
															<tr>
																<td><strong>Website :</strong>Jobslist.com</td>
															</tr>
															<tr>
																<td><strong>Email :</strong> georgemestayer@Jobslist.com</td>
															</tr>
															<tr>
												...
												<div class="row mt-5 profie-img">
													...
													<img class="img-fluid rounded w-25 h-25 m-2" src="<?php echo base_url();?>/assets/images/photos/8.jpg " alt="banner image">
													<img class="img-fluid rounded w-25 h-25 m-2" src="<?php echo base_url();?>/assets/images/photos/10.jpg" alt="banner image ">
													<img class="img-fluid rounded w-25 h-25 m-2" src="<?php echo base_url();?>/assets/images/photos/11.jpg" alt="banner image ">
												</div>
											</div>
										</div>
									</div>
									...
									<div class="card-body">
										<div class="d-flex">
											<div class="fb-user-thumb">
												<img src="<?php echo base_url();?>/assets/images/users/male/25.jpg" alt="" class="avatar brround avatar-md" >
											</div>
											<div class="ml-2">
