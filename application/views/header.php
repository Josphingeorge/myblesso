					...
					<div class="container-fluid">
						<div class="d-flex">
							<a class="header-brand" href="index.html">
								<img src="<?php echo base_url();?>/assets/images/brand/new.jpg" class="header-brand-img" alt="Jobslist logo">
							</a>
							...
							<div class="d-flex order-lg-2 ml-auto">
								...
								<div class="dropdown ">
									<a href="#" class="nav-link pr-0 leading-none user-img" data-toggle="dropdown">
										<img src="<?php echo base_url();?>/assets/images/users/male/25.jpg" alt="profile-img" class="avatar avatar-md brround">
									</a>
									<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow ">
				...
				<aside class="app-sidebar doc-sidebar">
					...
					<ul class="side-menu">
						...
						<li class="slide">
							...
							<ul class="slide-menu">
								<li>
									<a href="<?php echo base_url('Paymentorders');?>" class="slide-item">Transcation Details</a>
								</li>
